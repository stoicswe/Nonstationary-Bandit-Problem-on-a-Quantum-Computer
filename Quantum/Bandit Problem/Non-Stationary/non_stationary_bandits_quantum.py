...
def generate_reward(action, k):
    ...
    # the values initialized here represents the initial distribution
    #values = [0.1, 0, 0.3, 0.6]
    values = [0.6, 0, 0.1, 0.3]
...
bandits = [0.6, 0, 0.1, 0.3]
num_bandits = 4 #len(bandits)
...
while i < total_episodes:
    ...
    values, reward = generate_reward(action, k)
